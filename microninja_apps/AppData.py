...
_SYSTEM_ICONS_LOC = '/usr/share/microninja-applications/'
...
def get_applications(parse_cmds=True):
    ...
    blacklist = [
        ...
        "make-snake.desktop", "microninja-video.desktop", "lxsession-edit.desktop",
...
def _load_from_dentry(de_path):
    ...
    app = {
        "type": "app",
        "origin": de_path,
        "categories" : de["Categories"].split(";"),
        "title": de["Name"],
        "tagline": "",
    ...
    lang_code = loc[0]
    lang = lang_code[0:2]
    if "Comment[" + lang_code + "]" in de:
        app["tagline"] = de["Comment[" + lang_code + "]"]
    elif "Comment[" + lang + "]" in de:
        app["tagline"] = de["Comment[" + lang + "]"]
    elif "Comment" in de:
